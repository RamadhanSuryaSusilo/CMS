			...
			<div class="container center" data-aos="fade-up"> <br>
				<div class="section-header">
					...
					<div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
						<?php foreach ($galery as $ayah) { ?>
						<div class="col-lg-4 col-md-6 portfolio-item filter-remodeling">
							<div class="portfolio-content h-100">
								<img src="<?= base_url('assets/upload/galery/'). $ayah['foto']; ?>" class="img-fluid"
									alt="">
								<div class="portfolio-info">
									<h4><?= $ayah['tanggal']; ?></h4>
									<p><?= $ayah['judul']; ?></p>
									<a href="<?= base_url('assets/upload/galery/'). $ayah['foto']; ?>"
										title="More Details" target="blank" class="details-link"><i
